  ...
  return (
    <ScrollView
      ...
      <Text style={[styles.body, { fontFamily: 'Nunito_400Regular' }]}>
        Because you are under 18, you need permission from a parent or guardian to use WildKind.
      </Text>
      <Text style={[styles.body, { fontFamily: 'Nunito_400Regular' }]}>
        Your captures are private unless you publish them. Public map sharing and location settings can be managed in Settings.
      </Text>
      ...
      <Pressable
        ...
        <Text style={[styles.checkLabel, { fontFamily: 'Nunito_400Regular' }]}>
          I confirm that my parent or guardian allows me to use WildKind and agrees to the Terms of Use and Privacy Policy.
        </Text>
      </Pressable>
