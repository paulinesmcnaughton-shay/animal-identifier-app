...
export const SPECIES_CATALOG: Record<string, SpeciesDetail> = {
  ...
  robin: {
    ...
    vitals: [
      { label: 'LENGTH', value: '23–28 cm', icon: 'resize', tint: '#DEF1F8', iconColor: '#2A8FB8' },
      { label: 'TOP SPEED', value: '25 km/h', icon: 'flash', tint: '#FFEBEB', iconColor: '#FF6B5B' },
      { label: 'LIFESPAN', value: '2 years avg.', icon: 'heart', tint: '#EDE0FB', iconColor: '#A855F7' },
      { label: 'DIET', value: 'Insects, berries', icon: 'leaf', tint: '#ECF7D6', iconColor: '#65A30D' },
    ],
    taxonomy: {
      kingdom: 'Animalia',
  ...
  cardinal: {
    ...
    region: 'North America',
    sounds: true,
    description: 'Bright red males sing from treetops year-round. Look for the crest and thick orange bill.',
    gradient: ['#FF6B5B', '#A83232'],
    stats: [],
    vitals: [],
    taxonomy: {
      kingdom: 'Animalia',
  ...
  owl: {
    ...
    region: 'Worldwide',
    sounds: true,
    description: 'Ghostly pale owl of open country. Listen for harsh screeches over fields at night.',
  ...
  bumblebee: {
    ...
    sounds: false,
    description: 'Fuzzy pollinator buzzing between wildflowers. Often nests underground in old rodent burrows.',
    gradient: ['#FFC93C', '#7C3AED'],
    stats: [],
    vitals: [],
    taxonomy: {
      kingdom: 'Animalia',
  ...
  deer: {
    ...
    region: 'North America',
    sounds: true,
    description: 'Graceful browser with a white tail flash when alarmed. Most active at dawn and dusk.',
    gradient: ['#C28A52', '#92633A'],
    stats: [],
    vitals: [],
    taxonomy: {
      kingdom: 'Animalia',
  ...
  turtle: {
    ...
    latinName: 'Terrapene carolina',
    kingdom: 'reptile',
    rarity: 'Common',
    conservation: 'Vulnerable',
    region: 'Eastern United States',
    sounds: false,
    description: 'Domed shell with striking yellow patterns. Slow mover — give it space on woodland trails.',
    gradient: ['#52b788', '#0E8F65'],
    stats: [],
    vitals: [],
    taxonomy: {
      kingdom: 'Animalia',
  ...
  snail: {
    ...
    latinName: 'Cornu aspersum',
    kingdom: 'mollusc',
    rarity: 'Common',
    conservation: 'Least Concern',
    region: 'Worldwide (introduced)',
    sounds: false,
    description: 'Classic spiral shell gliding on garden paths after rain. Leaves a glistening slime trail.',
    gradient: ['#FCE7C7', '#B45309'],
    stats: [],
    vitals: [],
    taxonomy: {
      kingdom: 'Animalia',
  ...
  spider: {
    id: 'spider',
    dexNumber: '#072',
    commonName: 'Spotted Orbweaver',
    latinName: 'Neoscona crucifera',
    kingdom: 'arachnid',
    rarity: 'Common',
    conservation: 'Least Concern',
    region: 'North America',
    sounds: false,
    description: 'Orb-shaped web builder often seen in gardens. Harmless to humans — great mosquito catcher.',
    gradient: ['#E0E1F8', '#4338CA'],
    stats: [],
    vitals: [],
    taxonomy: {
      kingdom: 'Animalia',
  ...
  frog: {
    id: 'frog',
    dexNumber: '#088',
    commonName: 'American Green Tree Frog',
    ...
    sounds: true,
    description: 'Bright green climber calling from wetlands after rain. Often found on cattails and reeds.',
    gradient: ['#52b788', '#1a3d2b'],
    stats: [],
    vitals: [],
    taxonomy: {
  ...
  squirrel: {
    ...
    region: 'Eastern North America',
    sounds: true,
    description: 'Acrobatic park resident with a bushy tail. Watch them bury acorns in autumn.',
    gradient: ['#C28A52', '#92633A'],
    stats: [],
    vitals: [],
    taxonomy: {
  ...
  dolphin: {
    id: 'dolphin',
    dexNumber: '#071',
    commonName: 'Short-beaked Common Dolphin',
    ...
    sounds: true,
    description: 'Fast, social cetacean with an hourglass side pattern. Often rides bow waves near boats.',
  ...
  penguin: {
    ...
    region: 'Antarctica',
    sounds: true,
    description: 'Tallest penguin species, breeding through the Antarctic winter. Deep divers on sea ice.',
    gradient: ['#A8D8EA', '#2A8FB8'],
    stats: [],
    vitals: [],
    taxonomy: {
      kingdom: 'Animalia',
...
export function getSpeciesDetail(
  ...
  const resolvedLatin =
    overrides?.latinName ??
    getLatinNameForSpeciesId(id) ??
    resolveLatinName({ speciesId: id, commonName })
  const dexNumber =
    overrides?.dexNumber ??
    resolveGlobalDexNumber({
      speciesId: id,
      commonName,
      latinName: overrides?.latinName,
      kingdom: overrides?.kingdom,
    })
  return {
    id,
    dexNumber,
    commonName,
    latinName: resolvedLatin ?? 'Species unknown',
