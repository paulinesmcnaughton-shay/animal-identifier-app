...
const FOX: SpeciesDetail = {
  ...
  stats: [
    ...
    { label: 'STAMINA', value: 85, color: '#15B981' },
...
const MONARCH: SpeciesDetail = {
  ...
  stats: [
    ...
    { label: 'STAMINA', value: 92, color: '#15B981' },
...
export const SPECIES_CATALOG: Record<string, SpeciesDetail> = {
  ...
  '2': {
    ...
    gradient: ['#7FD8BE', '#15B981'],
    spottedAt: 'Yesterday',
    stats: [
      { label: 'SPEED', value: 55, color: '#FF6B5B' },
      { label: 'STAMINA', value: 70, color: '#15B981' },
  ...
  corgi: {
    ...
    stats: [
      ...
      { label: 'STAMINA', value: 78, color: '#15B981' },
...
export function getSpeciesDetail(
  ...
  return {
    ...
    stats: overrides?.stats ?? [
      ...
      { label: 'STAMINA', value: 50, color: '#15B981' },
